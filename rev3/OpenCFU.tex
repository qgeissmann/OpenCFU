...
\note[QG]{Here I added a quick description of alternative methods that I did not use. I preferred not to name them at this point because it could
confuse the reader. More information regarding the impossibility to use these method are meanwhile provided in the discussion}
...
\note[QG]{As requested, the long explanation about the impossibility to formally compare OpenCFU to other methods has been moved to the discussion}
...
\section*{Discussion}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\note[QG]{In this new paragraph, I describe why I could not compare OpenCFU to other alternatives than NICE and \IJM{}}
